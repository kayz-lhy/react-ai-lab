    ...
    return (
        <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="flex flex-col flex-grow">
                {/* 顶部工具栏 */}
                <header className="flex items-center justify-between h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 transition-colors duration-300">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            className="px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                            title="切换语言"
                        >
                            {language}
                        </button>
                ...
                {/* 主体内容 */}
                <main className="flex-grow container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 overflow-auto">
                    <Card
                        className="mx-auto"
                        header={<div className="text-xl font-semibold select-none">{headerContent}</div>}
                        footer={<div className="text-sm text-gray-500 dark:text-gray-400 select-none">卡片底部信息</div>}
                    >
                        <Outlet />
                    </Card>
                </main>
